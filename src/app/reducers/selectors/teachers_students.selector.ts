import { LoadTeachersState } from '../teachers/load-teachers-reducer.reducer';
...
export const teachers_students_selector = createSelector(teachers, students, (teachers: LoadTeachersState, students: StudentsState): LoadTeachersState => {
